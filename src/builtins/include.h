...
map<size_t, fptr> builtins = {
    ...
    { new_symbol("check-trait"), builtin::check_trait },
    { new_symbol("check-type"), builtin::check_type },
    { new_symbol("cond"), builtin::cond },
    { new_symbol("equal"), builtin::equal },
    ...
    { new_symbol("loop"), builtin::while_b },
